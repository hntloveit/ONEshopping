...
class ConfirmOneEmail extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        $et = EmailTemplate::get_template('send-one-to-user');
        ...
        $extra = (isset($this->sendone->code) ? 'Your code is : '. $this->sendone->code . '' : '');
        return (new MailMessage)
            ...
            ->action($this->sendone->code, route('/'))
            ->line($extra)
