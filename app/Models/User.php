...
class User extends Authenticatable // implements MustVerifyEmail
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password', 'lastLogin', 'role', 'level', 'left_code', 'right_node', 'grand_parent','referral', 'referralInfo',
		'email_verified_at', 'status', 'registerMethod', 'social_id', 'mobile', 'dateOfBirth', 'nationality', 'walletType', 'walletAddress',
		'contributed', 'tokenBalance', 'sendone_user', 'google2fa', 'google2fa_secret', 'type', 'remember_token','created_at', 'updated_at'
    ];
