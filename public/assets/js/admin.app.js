/*! TokenLite v1.1.5 | Copyright by Softnio. */ ! function(t) {
    var e = t("#ajax-modal"),
	...
	var f = t("form#percentperreferral");
    if (f.length > 0) {
        var h = f.find(_button_submit);
        f.find(a).on("keyup change", function() {
            btn_actived(h)
    ...
    t(document).on("click", "a.user-action", function(a) {
        a.preventDefault();
        var own = t(this).data("own");
        var n = t(this).data("type"),
            o = "suspend_user" == n ? "warning" : "info",
            nb = "sendone_user" == n ? "warning" : "info",
            onb = "on_sendone_user" == n ? "warning" : "info",
            i = t(this).data("uid");
        "transactions" == n || "activities" == n || "referrals" == n ? (e.empty(), e.parent().find(".modal-backdrop").remove(), t.post(show_user_info, {
            ...
            })) : "suspend_user" != n && "sendone_user" != n && "on_sendone_user" != n && "active_user" != n && "reset_pwd" != n && "reset_2fa" != n || swal({
            title: "Are you sure?",
            icon: o,
            buttons: ["Cancel", "Yes"],
            dangerMode: !0
            ...
            a && t.post(view_user_url, {
				...
				if(own == 'sendone') hml = '<li><a href="#" data-uid="' + i + '" data-own="sendone" data-type="' + ("sendone_user" == n ? "on_sendone_user" : "sendone_user") + '" class="user-action"><em class="fas fa-ban"></em>' + ("sendone_user" == n ? "ON Send ONE" : "OFF Send ONE") + "</a></li>";
                else html = '<li><a href="#" data-uid="' + i + '" data-type="' + a.status + '" class="user-action"><em class="fas fa-ban"></em>' + ("suspend_user" == n ? "Active" : "Suspend") + "</a></li>";
				null != a.msg && show_toast(a.msg, a.message), cl(a), ("active_user" == n || (n = "suspend_user") || "sendone_user" == n || "on_sendone_user" == n) && t(this).fadeOut(200, function() {
                    t(this).remove()
                }), t(document).find(".status_user").find(".badge").removeAttr("class").addClass("badge badge-" + a.css + " ucap"), t(".more-menu-" + i).append(hml), e.html(a), e.children(".modal").modal("show")
            })
        })
