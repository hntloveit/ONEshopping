        ...
        <div class="tab-content" id="profile-details">
            ...
            <div class="tab-pane fade" id="settings">
                <form class="validate-modern" action="{{ route('user.ajax.account.update') }}" method="POST" id="nio-user-settings">
					...
					<div class="input-item">
                        <input name="notifications" class="input-switch input-switch-sm" type="checkbox" @if($userMeta->notifications == 1) checked="" @endif id="notifications">
                        <label for="notifications">{{__('Turn on score multiplier notifications')}}</label>
                    </div>
