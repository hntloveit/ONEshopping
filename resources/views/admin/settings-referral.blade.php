                ...
                <div class="content-area card">
                    <div class="card-innr">
						...
						<ul class="nav nav-tabs nav-tabs-line" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tab_general">General</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#tab_refdetail">Referral detail</a>
                            </li>
                                    ...
                                    <div class="col-12">
                                        <div class="switch-content switch-to-referral">
                                            ...
                                            <div class="row">
												...
												<div class="col-lg-3 col-md-6 col-sm-12">
                                                    <div class="input-item input-with-label">
                                                        <label class="input-item-label">Number of Referral</label>
                                                        <div class="input-wrap">
                                                            <input type="number" class="input-bordered" min="1" name="referral_number" value="{{ get_setting('referral_number') }}">
                                                        </div>
                                                        <span class="input-note">The number of the affiliate in the system.</span>
                                                    </div>
                                                </div>
                                            </div>
					   ...
					   <div class="tab-pane fade " id="tab_refdetail">
							<form action="{{ route('admin.ajax.settings.update') }}" method="POST" id="percentperreferral" class="validate-modern">
								<p>% bonus per Referral</p> 
								<div class="row">
								<?php for($i=1;$i<=$referral_number;$i++) { ?>
									<div class="col-lg-3 col-md-6 col-sm-12">
										<div class="input-item input-with-label">
											<label class="input-item-label">Referral {{$i}}</label>
											<div class="input-wrap">
												<input type="number" class="input-bordered" min="0" max="100" name="referral{{$i}}" value="{{ get_setting('referral'.$i.'') }}">
											</div>
											<span class="input-note">The number percent of bonus.</span>
										</div>
									</div>
								<?php } ?>
								</div>
								@csrf
                                <input type="hidden" name="type" value="refdetail">
								<div class="gaps-1x"></div>
                                <div class="d-flex">
                                    <button class="btn btn-primary save-disabled" type="submit" disabled><i class="ti ti-reload"></i><span>Update</span></button>
                                </div>
