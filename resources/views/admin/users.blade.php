                                    ...
                                    <div class="toggle-class dropdown-content dropdown-content-top-left">
                                        <ul class="dropdown-list more-menu-{{$user->id}}">
                                            ...
                                            @if(Auth::id() != $user->id && $user->id != save_gmeta('site_super_admin')->value) 
												...
												@endif
												@if($user->sendone_user == 1)
												<li><a href="#" data-uid="{{ $user->id }}" data-own="sendone" data-type="sendone_user" class="user-action onefront"><em class="fas fa-random"></em>OFF Send ONE</a></li>
												@else
												<li><a href="#" id="onefront" data-uid="{{ $user->id }}" data-own="sendone" data-type="on_sendone_user" class="user-action"><em class="fas fa-sign-out-alt"></em>ON Send ONE</a></li>
												@endif	
											@endif
                                        </ul> 
                                    </div>
